...
def create_log_path(module_name: str)->str:
    '''
    Create a log file path based on the current data and provided module name

    Parameters:
    - module_name (str): The name of log file.
    ...
    # datetime is converted into string formate
...
create_log_path('test')

class CustomLogger:
    def __init__(self, logger_name, log_filename):
        '''
        Intilializes a custom logger with the specified name and log file

        Parameters:
        - logger_name (str):Name of the logger.
        - log_filenames(str): Path to the log file.
        '''
    ...
    def save_logs(self, msg, log_level='info'):
        '''
        Saves logs to the specified log file with the given  with the given message and log level.

        Parameters:
        - msg (str): Log message.
        - log_level (str): Log level ('debug', 'info', 'warnings', 'error', 'exception', 'critical').
        '''
